...
TOOLS = [
    ...
    ToolDefinition(
        ...
        description=(
            ...
            "zone' — for that, use get_config_history on the beamline's deploy/values.yaml (zones, "
            "devgroup, devtype list the actual inventory) to find the specific device names first."
        ),
